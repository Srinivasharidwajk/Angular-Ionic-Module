  ...
  private receipes:Receipe[] = [
    {
      id : 'AA0012',
      name : 'Butter Chicken',
      imageUrl : 'https://images.immediate.co.uk/production/volatile/sites/2/2015/12/18032.jpg?quality=90&resize=600%2C400',
      ingredients : ['chicken' , 'butter' , 'Red Chilli'],
      description : 'To make Masala Chicken, first thoroughly wash the chicken under running water. Now put it in some warm salted water and allow it to rest for 10 minutes and throw the water away and wash again. This helps to remove the smell of the chicken.'
    },
    {
      id : 'AA0013',
      name : 'Chicken Masala',
